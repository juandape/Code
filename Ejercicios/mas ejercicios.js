...
//   const word1 =[]
//    for(let i in word){
//    word1.push(word[i][0].toUpperCase() + word[i].substring(1))
//    }
//    return word1.join(" ")

// }

// console.log(upperCase("el carro azul"))
...
// console.log(bigger(3,5,6))
// console.log(bigger(20,10, 80))

// function divBy2(num){
//   if(num %2 === 0){
//   return `divisible por 2`
// }
// return `no es divisible por 2`
// }

// console.log(divBy2(4))
// console.log(divBy2(14))
...
//     }
//   }
//   return `en la frase hay ${count} letras "a"`
// }

// console.log(letterA("la vida es bella"))
// console.log(letterA("andrea aguilar la casa"))
...
//     voc = voc + "u"
//   }
//   return `la frase tiene las vocales ${voc}`
// }

// console.log(vocales("la frase contiene muchas vocales"))
// console.log(vocales("la frase contiene"))
...
//       }
//     }
//       return `la frase tiene ${count} letras vocales`

// }

// console.log(numVocales("la frase contiene muchas vocales")) //12
// console.log(numVocales("la frase contiene")) //7

// function totVocales(string) {
//   let counta = 0;
//   let counte = 0;
//   let counti = 0;
//   let counto = 0;
...
//     }
//   }
//   return `la frase tiene: ${counta} vocales "a", ${counte} vocales "e"
//   , ${counti} vocales "i", ${counto} vocales "o", ${countu} vocales "u" `;
// }

// console.log(totVocales("la frase contiene muchas vocales"))
// console.log(totVocales("la frase contiene"))

// function divisibleBy(num) {
//   let divi = "";
//   if (num % 2 === 0) {
//     divi += "divisible por 2, ";
//   }
//   if (num % 3 === 0) {
//     divi += "divisible por 3, ";
//   }
//   if (num % 5 === 0) {
//     divi += "divisible por 5, ";
//   }
//   if (num % 7 === 0) {
//     divi += "divisible por 7, ";
//   }
...
// console.log(divisibleBy(1943));
// console.log(divisibleBy(70));
